 ...
 *   2. sudo -- sh -c 'echo "127.0.0.1 agentn.us.api5.cursor.sh" >> /etc/hosts'
 ...
 *   MITM_TARGET     — upstream host (default: agentn.us.api5.cursor.sh)
...
const TARGET_HOST = process.env.MITM_TARGET || "agentn.us.api5.cursor.sh";
